            ...
            <div class="row" id="myRow" >
                <div class="col-md-8 mx-auto">
                    ...
                    <div id="subjectsContainer">
                        <a href="chapterMain.php?subjectName=Higher+Mathematics" class="subject" id="higherMath">Higher Mathematics</a>
                        <a href="chapterMain.php?subjectName=Physics" class="subject" id="physics">Physics</a>
