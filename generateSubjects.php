            ...
            <div class="row" id="myRow" >
                <div class="col-md-8 mx-auto">
                    ...
                    <div id="subjectsContainer">
                        <a href="generateMain.php?subject=hmath" class="subject" id="higherMath">Higher Mathematics</a>
                        <a href="generateMain.php?subject=physics" class="subject" id="physics">Physics</a>
